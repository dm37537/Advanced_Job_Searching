...
{
	$referenceID = 1;
	$companyName = "Hackensack General Hospital";
	$relationship = "Supervisor";
	$jobTitle = "Head Nurse";
	$name = "Scott Summers";
	$email = "S_summers@hack_hosp.com";
	$additionalInformation = "James Logan worked as registered nurse from 2011-2013. During this period, he worked very hard and diligently. He even got certification on the Oncology Nursing Certificate while working under my supervision. I highly recommend to other hospital. ";
	$rating = 9;
	$duration = 24;
	$status = 1;
...
<html> 
	<form method="post" action="<?php $_SERVER['PHP_SELF'];?>"> 
	   ...
	   <input type="button" name='cancel' value="Cancel" onclick="location.href='/main.php'" />
		 <input type="button" name='GenerateDemo' value="GenerateDemo" onclick="location.href='reference.php?mode=Demo'" />
	</form>
</html>