...
<html> 
	...
	<form method="post" action="<?php $_SERVER['PHP_SELF'];?>"> 
		...
		<input type="button" name='GenerateDemo' value="GenerateDemo" onclick="location.href='Resume.php?mode=Demo&resumeUserID=<?php echo $resumeUserID;?>'" />	
	</form>
	<?php oci_close($conn); ?>
</html>